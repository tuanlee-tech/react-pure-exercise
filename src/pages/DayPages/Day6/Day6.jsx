    ...
    <div className="day-content">
      <div className="day-header">
        <div className="day-header-content">
          ...
          <div>
            <h1 className="day-title">Ngày 6</h1>
            <p className="day-subtitle">useState Mastery</p>
          </div>
        </div>
        <section className="lesson-goal">
          <h2>🎯 Mục tiêu hôm nay</h2>
          <ul>
            <li>Hiểu sâu về useState hook</li>
            <li>Lazy initialization</li>
            <li>State immutability</li>
            <li>Best practices và patterns</li>
            <li>Tránh những lỗi phổ biến</li>
          </ul>
        </section>
      </div>
