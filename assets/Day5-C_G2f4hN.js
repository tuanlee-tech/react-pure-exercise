import{r as reactExports,j as jsxRuntimeExports,C as CodeXml}from"./index-BS3qSuky.js";/* empty css               */import{E as ExerciseCard}from"./ExerciseCard-mXl7boCG.js";import{C as Card,I as Input,B as Button,a as Checkbox,S as Select}from"./tooltip-bGaQcz33.js";const DATA_KEY="todos";function loadTodos(){try{const s=localStorage.getItem(DATA_KEY);if(!s)return[];const e=JSON.parse(s);return Array.isArray(e)?e:[]}catch(s){return console.error("Invalid todos data:",s),localStorage.removeItem(DATA_KEY),[]}}function TodoList(){const[s,e]=reactExports.useState(()=>loadTodos()),[t,r]=reactExports.useState(""),[n,a]=reactExports.useState("all");reactExports.useEffect(()=>{localStorage.setItem(DATA_KEY,JSON.stringify(s))},[s]);const c=()=>{t.trim()&&(e(o=>[...o,{id:Date.now(),text:t.trim(),completed:!1}]),r(""))},u=o=>{e(x=>x.map(g=>g.id===o?{...g,completed:!g.completed}:g))},l=o=>{e(x=>x.filter(g=>g.id!==o))},p=s.filter(o=>n==="active"?!o.completed:n==="completed"?o.completed:!0);return jsxRuntimeExports.jsx("div",{className:"todo-app",children:jsxRuntimeExports.jsxs(Card,{className:"todo-card",children:[jsxRuntimeExports.jsx("h2",{className:"todo-title",children:"Todo List"}),jsxRuntimeExports.jsxs("div",{className:"todo-input-group",children:[jsxRuntimeExports.jsx(Input,{placeholder:"What needs to be done?",value:t,onChange:o=>r(o.target.value),onKeyPress:o=>o.key==="Enter"&&c(),className:"todo-input"}),jsxRuntimeExports.jsx(Button,{variant:"primary",size:"md",onClick:c,children:"Add"})]}),jsxRuntimeExports.jsx("div",{className:"filter-group",children:["all","active","completed"].map(o=>jsxRuntimeExports.jsx(Button,{variant:n===o?"primary":"ghost",size:"sm",onClick:()=>a(o),className:"filter-btn",children:o.charAt(0).toUpperCase()+o.slice(1)},o))}),jsxRuntimeExports.jsx("ul",{className:"todo-list",children:p.length===0?jsxRuntimeExports.jsx("p",{className:"empty-state",children:n==="all"?"No todos yet. Add one!":`No ${n} todos.`}):p.map(o=>jsxRuntimeExports.jsxs("li",{className:"todo-item",children:[jsxRuntimeExports.jsx(Checkbox,{checked:o.completed,onChange:()=>u(o.id)}),jsxRuntimeExports.jsx("span",{className:`todo-text ${o.completed?"completed":""}`,children:o.text}),jsxRuntimeExports.jsx(Button,{variant:"ghost",size:"sm",onClick:()=>l(o.id),className:"delete-btn",children:"Delete"})]},o.id))}),jsxRuntimeExports.jsx("div",{className:"todo-stats",children:jsxRuntimeExports.jsxs("span",{children:[s.filter(o=>!o.completed).length," active •"," ",s.filter(o=>o.completed).length," completed"]})})]})})}function Exercise1(){return jsxRuntimeExports.jsxs(ExerciseCard,{children:[jsxRuntimeExports.jsx(ExerciseCard.Header,{order:1,title:"Convert Class to Function"}),jsxRuntimeExports.jsx(ExerciseCard.Description,{children:`
