...
`})]})}const F=[{symbol:"AAPL",name:"Apple Inc.",price:150,change:0,history:[]},{symbol:"GOOGL",name:"Alphabet Inc.",price:2800,change:0,history:[]},{symbol:"MSFT",name:"Microsoft Corp.",price:300,change:0,history:[]},{symbol:"TSLA",name:"Tesla Inc.",price:700,change:0,history:[]},{symbol:"AMZN",name:"Amazon.com Inc.",price:3200,change:0,history:[]},{symbol:"META",name:"Meta Platforms",price:280,change:0,history:[]}];function J(){const[a,l]=n.useState(F),[c,v]=n.useState("AAPL"),[i,p]=n.useState([]),[r,b]=n.useState(!1),[N,g]=n.useState({}),[y,x]=n.useState(!1),[S,u]=n.useState(""),[h,k]=n.useState(""),[j,T]=n.useState("above"),A=n.useRef(0);n.useEffect(()=>(b(!0),()=>b(!1)),[]),n.useEffect(()=>{if(!r)return;const s=setInterval(()=>{l(d=>d.map(f=>{const I=(Math.random()-.5)*.1,P=f.price*I,R=Math.max(f.price+P,1),L=F.find(B=>B.symbol===f.symbol)?.price||f.price,O=(R-L)/L*100;return{...f,price:parseFloat(R.toFixed(2)),change:parseFloat(O.toFixed(2))}})),A.current+=1},2e3);return()=>clearInterval(s)},[r]),n.useEffect(()=>{const s=a.find(d=>d.symbol===c);s&&p(d=>[...d,{time:new Date().toLocaleTimeString(),price:s.price,timestamp:Date.now()}].slice(-20))},[a,c]),n.useEffect(()=>{a.forEach(s=>{const d=N[s.symbol];if(!d)return;(d.type==="above"&&s.price>=d.price||d.type==="below"&&s.price<=d.price)&&!d.triggered&&("Notification"in window&&Notification.permission==="granted"&&new Notification(`Stock Alert: ${s.symbol}`,{body:`Price ${d.type} $${d.price}. Current: $${s.price}`,icon:"📈"}),g(I=>({...I,[s.symbol]:{...d,triggered:!0}})),E(s.symbol,s.price,d))})},[a,N]);const E=(s,d,f)=>{console.log(`Alert triggered for ${s}: $${d} is ${f.type} $${f.price}`)},t=()=>{!S||!h||(g(s=>({...s,[S]:{price:parseFloat(h),type:j,triggered:!1}})),x(!1),u(""),k(""))},o=s=>{g(d=>{const f={...d};return delete f[s],f})},D=()=>{"Notification"in window&&Notification.permission==="default"&&Notification.requestPermission()},C=()=>i.length===0?0:Math.min(...i.map(s=>s.price)),M=()=>i.length===0?0:Math.max(...i.map(s=>s.price)),w=a.find(s=>s.symbol===c);return e.jsxs("div",{className:"stock-ticker-app",children:[e.jsxs("div",{className:"app-container",children:[e.jsxs("div",{className:"app-header",children:[e.jsxs("div",{className:"header-left",children:[e.jsx("h1",{className:"header-title",children:"📈 Live Stock Ticker"}),e.jsx("p",{className:"header-subtitle",children:"Real-time stock price updates"})]}),e.jsxs("div",{className:"header-right",children:[e.jsxs("div",{className:`connection-status ${r?"connected":"disconnected"}`,children:[e.jsx("span",{className:"status-dot"}),e.jsx("span",{className:"status-text",children:r?"Connected":"Disconnected"})]}),e.jsxs("div",{className:"update-count",children:["Updates: ",A.current]})]})]}),e.jsxs("div",{className:"content-grid",children:[e.jsxs("div",{className:"stock-list-panel",children:[e.jsxs("div",{className:"panel-header",children:[e.jsx("h2",{className:"panel-title",children:"Stocks"}),e.jsx("button",{onClick:()=>x(!0),className:"btn-add-alert",title:"Add Price Alert",children:"🔔 Alert"})]}),e.jsx("div",{className:"stock-list",children:a.map(s=>{const d=c===s.symbol,f=N[s.symbol];return e.jsxs("div",{className:`stock-item ${d?"selected":""}`,onClick:()=>v(s.symbol),children:[e.jsxs("div",{className:"stock-item-left",children:[e.jsx("div",{className:"stock-symbol",children:s.symbol}),e.jsx("div",{className:"stock-name",children:s.name})]}),e.jsxs("div",{className:"stock-item-right",children:[e.jsxs("div",{className:"stock-price",children:["$",s.price.toFixed(2)]}),e.jsxs("div",{className:`stock-change ${s.change>=0?"positive":"negative"}`,children:[e.jsx("span",{className:"change-arrow",children:s.change>=0?"↑":"↓"}),Math.abs(s.change).toFixed(2),"%"]})]}),f&&e.jsx("div",{className:"alert-indicator",title:"Price alert set",children:"🔔"})]},s.symbol)})}),Object.keys(N).length>0&&e.jsxs("div",{className:"alerts-section",children:[e.jsx("h3",{className:"alerts-title",children:"Active Alerts"}),e.jsx("div",{className:"alerts-list",children:Object.entries(N).map(([s,d])=>e.jsxs("div",{className:"alert-item",children:[e.jsxs("div",{className:"alert-info",children:[e.jsx("span",{className:"alert-symbol",children:s}),e.jsxs("span",{className:"alert-condition",children:[d.type==="above"?"≥":"≤"," $",d.price]})]}),e.jsx("button",{onClick:()=>o(s),className:"btn-remove-alert",children:"✕"})]},s))})]})]}),e.jsxs("div",{className:"chart-panel",children:[e.jsxs("div",{className:"panel-header",children:[e.jsxs("div",{children:[e.jsxs("h2",{className:"panel-title",children:[w?.name," (",c,")"]}),e.jsxs("div",{className:"current-price-display",children:[e.jsxs("span",{className:"price-large",children:["$",w?.price.toFixed(2)]}),e.jsxs("span",{className:`change-large ${w?.change>=0?"positive":"negative"}`,children:[w?.change>=0?"+":"",w?.change.toFixed(2),"%"]})]})]}),e.jsx("button",{onClick:D,className:"btn-notifications",title:"Enable notifications",children:"🔔 Enable Notifications"})]}),e.jsxs("div",{className:"chart-container",children:[i.length===0?e.jsxs("div",{className:"chart-empty",children:[e.jsx("div",{className:"empty-icon",children:"📊"}),e.jsx("p",{children:"Collecting price data..."})]}):e.jsxs("div",{className:"chart",children:[e.jsxs("div",{className:"chart-y-axis",children:[e.jsxs("div",{className:"y-label",children:["$",M().toFixed(2)]}),e.jsxs("div",{className:"y-label",children:["$",((M()+C())/2).toFixed(2)]}),e.jsxs("div",{className:"y-label",children:["$",C().toFixed(2)]})]}),e.jsx("div",{className:"chart-area",children:e.jsxs("svg",{className:"chart-svg",viewBox:"0 0 800 300",preserveAspectRatio:"none",children:[e.jsx("defs",{children:e.jsxs("linearGradient",{id:"gradient",x1:"0%",y1:"0%",x2:"0%",y2:"100%",children:[e.jsx("stop",{offset:"0%",stopColor:"rgba(0, 217, 255, 0.3)"}),e.jsx("stop",{offset:"100%",stopColor:"rgba(0, 217, 255, 0)"})]})}),e.jsx("polyline",{points:i.map((s,d)=>{const f=d/(i.length-1)*800,I=M()-C(),P=I===0?150:300-(s.price-C())/I*300;return`${f},${P}`}).join(" "),fill:"none",stroke:"url(#lineGradient)",strokeWidth:"3",strokeLinecap:"round",strokeLinejoin:"round"}),e.jsx("polygon",{points:["0,300",...i.map((s,d)=>{const f=d/(i.length-1)*800,I=M()-C(),P=I===0?150:300-(s.price-C())/I*300;return`${f},${P}`}),"800,300"].join(" "),fill:"url(#gradient)"}),e.jsx("defs",{children:e.jsxs("linearGradient",{id:"lineGradient",x1:"0%",y1:"0%",x2:"100%",y2:"0%",children:[e.jsx("stop",{offset:"0%",stopColor:"#00D9FF"}),e.jsx("stop",{offset:"100%",stopColor:"#00A3CC"})]})})]})})]}),e.jsxs("div",{className:"stats-grid",children:[e.jsxs("div",{className:"stat-card",children:[e.jsx("div",{className:"stat-label",children:"High"}),e.jsxs("div",{className:"stat-value",children:["$",M().toFixed(2)]})]}),e.jsxs("div",{className:"stat-card",children:[e.jsx("div",{className:"stat-label",children:"Low"}),e.jsxs("div",{className:"stat-value",children:["$",C().toFixed(2)]})]}),e.jsxs("div",{className:"stat-card",children:[e.jsx("div",{className:"stat-label",children:"Data Points"}),e.jsxs("div",{className:"stat-value",children:[i.length,"/20"]})]}),e.jsxs("div",{className:"stat-card",children:[e.jsx("div",{className:"stat-label",children:"Last Update"}),e.jsx("div",{className:"stat-value",children:i[i.length-1]?.time||"--:--"})]})]})]})]})]})]}),y&&e.jsx("div",{className:"modal-overlay",onClick:()=>x(!1),children:e.jsxs("div",{className:"modal-content",onClick:s=>s.stopPropagation(),children:[e.jsxs("div",{className:"modal-header",children:[e.jsx("h3",{className:"modal-title",children:"Set Price Alert"}),e.jsx("button",{onClick:()=>x(!1),className:"modal-close",children:"✕"})]}),e.jsxs("div",{className:"modal-body",children:[e.jsxs("div",{className:"form-group",children:[e.jsx("label",{className:"form-label",children:"Stock"}),e.jsxs("select",{value:S,onChange:s=>u(s.target.value),className:"form-select",children:[e.jsx("option",{value:"",children:"Select stock..."}),a.map(s=>e.jsxs("option",{value:s.symbol,children:[s.symbol," - ",s.name]},s.symbol))]})]}),e.jsxs("div",{className:"form-group",children:[e.jsx("label",{className:"form-label",children:"Alert Type"}),e.jsxs("div",{className:"radio-group",children:[e.jsxs("label",{className:"radio-label",children:[e.jsx("input",{type:"radio",value:"above",checked:j==="above",onChange:s=>T(s.target.value),className:"radio-input"}),e.jsx("span",{children:"Price goes above"})]}),e.jsxs("label",{className:"radio-label",children:[e.jsx("input",{type:"radio",value:"below",checked:j==="below",onChange:s=>T(s.target.value),className:"radio-input"}),e.jsx("span",{children:"Price goes below"})]})]})]}),e.jsxs("div",{className:"form-group",children:[e.jsx("label",{className:"form-label",children:"Target Price ($)"}),e.jsx("input",{type:"number",value:h,onChange:s=>k(s.target.value),placeholder:"0.00",step:"0.01",min:"0",className:"form-input"})]})]}),e.jsxs("div",{className:"modal-footer",children:[e.jsx("button",{onClick:()=>x(!1),className:"btn-secondary",children:"Cancel"}),e.jsx("button",{onClick:t,className:"btn-primary",disabled:!S||!h,children:"Set Alert"})]})]})})]})}function V(){return e.jsxs(m,{children:[e.jsx(m.Header,{order:3,title:"Live Stock Ticker"}),e.jsx(m.Description,{children:`
...
`}),e.jsx(m.Demo,{children:e.jsx(J,{})}),e.jsx(m.Code,{children:`
import { useEffect, useRef, useState } from "react";
...
`}),e.jsx(m.Demo,{children:e.jsx(z,{})}),e.jsx(m.Code,{children:`
...
`})]})}function K(){return e.jsxs(m,{children:[e.jsx(m.Header,{order:"#",title:"Home Work"}),e.jsx(m.Description,{children:`
